...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'sales-manager', 'telecaller-agent', 'customer-service-representative'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Lead', path: '/leads', entity: 'lead', service: AccessServiceEnum.PROJECT, icon: FiTarget },
